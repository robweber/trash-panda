__/api/status/group/__ - detailed listing of the status of each host in a group. This does not include service information, use `/api/status/host/<host_id>` to get the full listing with services.
